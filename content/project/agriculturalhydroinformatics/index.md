...
The field of hydroinformatics, as applied to agriculture, combines, coordinates and interplays with many scientific fields of study, and even agricultural practices, beyond hydrology, hydraulics, ecology, economics, and sociology. Consequently,  agricultural hydroinformatics promotes a sociotechnical-system approach to agricultural information and simulation models development. 

Hydroinformatics brings around the water-centric socio-technical transformations necessary to transitioning to sustainable agriculture practices. As such, it represents a cornerstone to implement precision agriculture which is a growingly accepted practice to achieve agricultural sustainability.

The diversity of the identified interplays is represented in the above framework that epitomizes the wholeness and inter-dependencies of agricultural systems studies and modelling. This discipline-delineated conceptual framework originating from the particularities of the socio-technical dimension of applying hydroinformatics in agriculture has been developed to constitute the foundation of this new research field. 
